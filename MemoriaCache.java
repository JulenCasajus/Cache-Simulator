...
public class MemoriaCache {
	...
	public static void main(String[] args) {
		...
		int Aux, TPalabra, TBloque, TConjunto, Palabras, Columnas, Direccion, TAcceso = 0;
		int PAbsoluta, Bloque, PEnBloque, Conjuntos, Tag, Conjunto;
		...
		//PEDIR DIRECCIONES MIENTRAS EL PROGRAMA FUNCIONE
			...
			System.out.println("\nEl tiempo total de acceso es de " + TAcceso + " ciclos.");
